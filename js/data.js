window.VISIONS = [
    {
        id: "classic",
        name: "Classic Gold",
        blurb: "Timeless elegance with gold accents and formal details.",
        icon: "✨"
    },
    {
        id: "garden",
        name: "Garden Floral",
        blurb: "Soft flowers, greenery, and a romantic outdoor feel.",
        icon: "🌸"
    },
    {
        id: "modern",
        name: "Modern Simple",
        blurb: "Clean lines, minimal decor, and a fresh modern look.",
        icon: "🤍"
    },
    {
        id: "traditional",
        name: "Traditional",
        blurb: "Cultural touches and classic wedding traditions.",
        icon: "💛"
    }
];
...
window.PACKAGES = {
    basic: {
        ...
        name: "Basic",
        price: 3000000,
        note: "Essential wedding details for a simple, beautiful day."
    },
    standard: {
        id: "standard",
        name: "Standard",
        price: 6500000,
        note: "A complete wedding with more style and extra choices."
    },
    premium: {
        id: "premium",
        name: "Premium",
        price: 12000000,
        note: "Luxury wedding with the finest options in every service."
    }
};
...
window.SERVICES = [
    {
        id: "dress",
        name: "Wedding Dress",
        blurb: "Find your perfect dress for your special day",
        icon: "👗"
    },
    {
        id: "food",
        name: "Wedding Food",
        blurb: "Delicious menus for your special day",
        icon: "🍽️"
    },
    {
        id: "shoes",
        name: "Wedding Shoes",
        blurb: "Step into elegance and comfort",
        icon: "👠"
    },
    {
        id: "accessories",
        name: "Accessories",
        blurb: "Shine with the perfect accessories",
        icon: "💍"
    },
    {
        id: "cakes",
        name: "Wedding Cakes",
        blurb: "Sweet moments, beautifully baked",
        icon: "🎂"
    },
    {
        id: "bouquets",
        name: "Bouquets",
        blurb: "Flowers that speak from your heart",
        icon: "💐"
    },
    {
        id: "decorations",
        name: "Decorations",
        blurb: "Decoration ideas that create magic",
        icon: "🌸"
    },
    {
        id: "locations",
        name: "Locations",
        blurb: "Beautiful places for your wedding day",
        icon: "📍"
    }
];
